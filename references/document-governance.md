...
- 用户提供或外部生成的参考截图、修改截图、设计截图、目标效果图或验收目标图，能访问到文件时必须复制或归档到 `docs/codex/assets/visual-references/`，并在相关文档中记录路径、来源、页面/模块、用途、对照点和确认状态；Codex 执行或验收产生的截图才归档到 `docs/codex/assets/qa/<Work ID>/`。
- 任务完成后必须更新相关文档。
