...
| ID | 文件/来源 | 页面/模块 | 用途 | 必须对齐点 | 禁止点 | 确认状态 |
| --- | --- | --- | --- | --- | --- | --- |
| VR-001 | docs/codex/assets/visual-references/ |  | reference / modify / old-system / design / target / acceptance-target |  |  | pending / confirmed / rejected |

### 参考产品

| ID | 产品/URL | 截图路径 | 页面/模块 | 借鉴点 | 禁止点 |
| --- | --- | --- | --- | --- | --- |
| VR-P-001 |  |  |  |  |  |
